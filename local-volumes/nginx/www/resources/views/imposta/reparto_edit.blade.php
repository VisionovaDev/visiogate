...
@section('content')
    <div class="container">
        <h3 class="fw-bold mb-3 mt-3">Modifica del reparto per la sede: {{ $sede->nome }}</h3>
        <form action="{{ route('imposta.reparto.update',$reparto->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-4 form-group mt-3 {{ $errors->has('nome_it') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="nome_it" name="nome_it" value="{{ old('nome_it',$reparto->nome_it) }}"
                        required>
                ...
                <div class="col-md-4 form-group mt-3 {{ $errors->has('nome_en') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="nome_en" name="nome_en" value="{{ old('nome_en',$reparto->nome_en) }}"
                        required>
                ...
                <div class="col-md-4 form-group mt-3 {{ $errors->has('nome_de') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="nome_de" name="nome_de" value="{{ old('nome_de',$reparto->nome_de) }}"
                        required>
                ...
                <div class="col-md-4 form-group mt-3 {{ $errors->has('nome_fr') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="nome_fr" name="nome_fr" value="{{ old('nome_fr',$reparto->nome_fr) }}"
                        required>
                ...
                <div class="col-md-4 form-group mt-3 {{ $errors->has('nome_es') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="nome_es" name="nome_es" value="{{ old('nome_es',$reparto->nome_es) }}"
                        required>
