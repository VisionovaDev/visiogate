...
@section('content')
    <div class="container">
        <h3 class="fw-bold mb-3">Modifica varco</h3>
        <form action="{{ route('imposta.varco.update',$varco->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-4 form-group mt-3 {{ $errors->has('nome') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" value="{{ old('nome',$varco->nome) }}"
                        required>
                    @if ($errors->has('nome'))
                ...
                <div class="col-md-2 mb-3 mt-3">
                    <div class="form-check form-switch">
                        ...
                        <input class="form-check-input" type="checkbox" role="switch" id="is_entrata"
                            ...
                            {{ old('is_entrata',$varco->is_entrata) ? 'checked' : '' }}>
                ...
                <div class="col-md-2 mb-3 mt-3">
                    <div class="form-check form-switch">
                        ...
                        <input class="form-check-input" type="checkbox" role="switch" id="is_uscita"
                            ...
                            {{ old('is_uscita',$varco->is_uscita) ? 'checked' : '' }}>
            ...
            <div class="mt-3">
                ...
                <a href="{{ route('imposta.varco.show',$varco->id) }}">
