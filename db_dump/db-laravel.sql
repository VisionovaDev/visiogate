...
-- Dump dei dati della tabella laravel.migrations: ~5 rows (circa)
...
-- Dump dei dati della tabella laravel.sessions: ~1 rows (circa)
DELETE FROM `sessions`;
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('8bVCoi0PaIDQ3CKlEBNpjPJN8I9uGU0lztS90MQz', NULL, '172.18.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiR1N5Y281R2x5b016RFdEWmkwcURrdjlxT0dBY2JydlVXQnNGSUlDQyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MTY6Imh0dHA6Ly9sb2NhbGhvc3QiO31zOjY6Il9mbGFzaCI7YToyOntzOjM6Im9sZCI7YTowOnt9czozOiJuZXciO2E6MDp7fX19', 1710497619);
...
-- Dump dei dati della tabella laravel.users: ~1 rows (circa)
DELETE FROM `users`;
